...
for doc in documents:
    ...
    pattern_words = [lemmatizer.lemmatize(word.lower()) for word in pattern_words if word and word not in ignore_words]
...
#Create Chat window
ChatLog = Text(base, bd=0,font="Verdana", bg="#66E2FF", height="65", width="115")
ChatLog.config(state=DISABLED)
...
ChatLog.place(x=6,y=6, height=435, width=440)
